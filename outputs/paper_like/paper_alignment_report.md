...
## 전체 표본 정렬 여부
- daily_standard_full: 불일치 | model=standard_csad | value=-0.180988 | t=-4.014 | p=5.96944e-05
  논문 기준: 본문 기준: standard CSAD는 전체 표본에서 herding을 보이지 않아야 합니다.
- daily_scsad_full_main: 불일치 | model=scsad | value=-0.394134 | t=-0.741 | p=0.458798
  논문 기준: 본문 기준: daily SCSAD는 전체 표본에서 herding을 지지해야 합니다.
- daily_scsad_full_appendix: 일치 | model=scsad | value=-0.394134 | t=-0.741 | p=0.458798
...
- daily_no_intercept_full: 일치 | model=no_intercept_csad | value=-0.833370 | t=-4.306 | p=1.66057e-05
...
## Daily vs Weekly 비교
- daily 전체표본 SCSAD: value=-0.394134, t=-0.741, p=0.458798
- weekly 전체표본 SCSAD: value=-0.583287, t=-1.826, p=0.0678276
- daily 전체표본 no-intercept: value=-0.833370, t=-4.306
...
## 하위 구간 강도 순위
- daily / standard_csad: 관측 순서 pre_covid > covid > post_covid | 논문 최상위 구간 일치 여부=False
- daily / no_intercept_csad: 관측 순서 post_covid > pre_covid > covid | 논문 최상위 구간 일치 여부=True
- daily / scsad: 관측 순서 post_covid > pre_covid > covid | 논문 최상위 구간 일치 여부=True
