...
[Natashekara와 Sampath (2026)](https://doi.org/10.1016/j.jbef.2026.101167)의 CoinMarketCap 62종목 저빈도 결과를 재현하는 데서 시작해, 다른 기간과 거래소에서도 같은 현상이 나타나는지 확인하고, 마지막에는 **집단추종이 없는 가상시장에서도 같은 신호가 생기는지** 실험했습니다.

## 요약

- 선행논문의 no-intercept CSAD·SCSAD 음의 계수를 가까운 값으로 재현했습니다.
- 하지만 설정한 집단추종 없는 가상시장 실험에서도 해당 음의 계수가 97~100%의 빈도로 나타났습니다.
